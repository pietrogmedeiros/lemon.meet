  ...
  return (
    <MainLayout>
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-[#333]">Minha Assinatura</h1>
              ...
              <Row
                ...
                value={
                  <span className={`font-semibold ${si.color}`}>
                    {planLabel[details.plan] ?? details.plan} — {si.label}
                  </span>
                }
              />
              ...
              <Row
                ...
                value={
                  details.amount !== null && details.currency
                    ? <span className="font-semibold text-[#333]">{formatCurrency(details.amount, details.currency)}<span className="text-xs text-[#999] font-normal ml-1">/mês</span></span>
              ...
              <Row
                ...
                value={
                  details.lastPayment
                    ...
                    : <span className="text-[#999]">Nenhum pagamento registrado</span>
                }
              />
              ...
              <Row
                ...
                value={
                  details.currentPeriodEnd
                    ? <span className="flex items-center gap-1.5 text-[#333]"><Calendar size={14} className="text-[#2D5A27]" />{formatDate(details.currentPeriodEnd)}</span>
                    : <span className="text-[#999]">—</span>
                }
              />
